export const Kanji = [
    ...
    { Id: '行', SinoVietnamese: 'HÀNH', On: 'コウ、ギョウ、アン', Kun: 'い、ゆ、おこな', Romaji: 'NoKanji' },
    { Id: '来', SinoVietnamese: 'LAI', On: 'ライ、タイ', Kun: 'く、き、こ、きた', Romaji: 'NoKanji' },
    { Id: '会', SinoVietnamese: 'HỘI', On: 'カイ、エ', Kun: 'あ', Romaji: 'NoKanji' },
    { Id: '休', SinoVietnamese: 'HƯU', On: 'キュウ', Kun: 'やす', Romaji: 'NoKanji' },
    { Id: '本', SinoVietnamese: 'BỔN', On: 'ホン', Kun: 'もと', Romaji: 'NoKanji' },
    { Id: '京', SinoVietnamese: 'KINH', On: 'キョウ、ケイ', Kun: 'きょう、けい', Romaji: 'NoKanji' },

    { Id: '私', SinoVietnamese: 'TƯ', On: 'シ', Kun: 'わたし、わたくし', Romaji: 'NoKanji' },
    { Id: '父', SinoVietnamese: 'PHỤ', On: 'フ', Kun: 'ちち', Romaji: 'NoKanji' },
    { Id: '母', SinoVietnamese: 'MẪU', On: 'ボ', Kun: 'はは、も', Romaji: 'NoKanji' },
    { Id: '子', SinoVietnamese: 'TỬ', On: 'シ、ス、ツ', Kun: 'こ、ね', Romaji: 'NoKanji' },
    { Id: '男', SinoVietnamese: 'NAM', On: 'ダン、ナン', Kun: 'おとこ', Romaji: 'NoKanji' },
    { Id: '女', SinoVietnamese: 'NỮ', On: 'ジョ、ニョ、ニョウ', Kun: 'おんな、め', Romaji: 'NoKanji' },
    { Id: '人', SinoVietnamese: 'NHÂN', On: 'ジン、ニン', Kun: 'ひと、り、と', Romaji: 'NoKanji' },
    { Id: '何', SinoVietnamese: 'HÀ', On: 'カ', Kun: 'なに、なん', Romaji: 'NoKanji' },

    { Id: '好', SinoVietnamese: 'HẢO', On: 'コウ', Kun: 'この、す、よ、い', Romaji: 'NoKanji' },
    { Id: '語', SinoVietnamese: 'NGỮ', On: 'ゴ', Kun: 'かた', Romaji: 'NoKanji' },
    { Id: '外', SinoVietnamese: 'NGOẠI', On: 'ガイ、ゲ', Kun: 'そと、ほか、はず、と', Romaji: 'NoKanji' },
    { Id: '国', SinoVietnamese: 'QUỐC', On: 'コク', Kun: 'くに', Romaji: 'NoKanji' },

    { Id: '春', SinoVietnamese: 'XUÂN', On: 'シュン', Kun: 'はる', Romaji: 'NoKanji' },
    { Id: '夏', SinoVietnamese: 'HẠ', On: 'カ、ガ、ゲ', Kun: 'なつ', Romaji: 'NoKanji' },
    { Id: '秋', SinoVietnamese: 'THU', On: 'シュウ', Kun: 'あき、とき', Romaji: 'NoKanji' },
    { Id: '冬', SinoVietnamese: 'ĐÔNG', On: 'トウ', Kun: 'ふゆ', Romaji: 'NoKanji' },
    { Id: '今', SinoVietnamese: 'KIM', On: 'コン、キン', Kun: 'いま', Romaji: 'NoKanji' },
    { Id: '花', SinoVietnamese: 'HOA', On: 'カ、ケ', Kun: 'はな', Romaji: 'NoKanji' },
    { Id: '海', SinoVietnamese: 'HẢI', On: 'カイ、ゲ', Kun: 'うみ', Romaji: 'NoKanji' },////////////////////////////////////////////////////////////////////
    { Id: '山', SinoVietnamese: 'SƠN, SAN', On: 'サン、セン', Kun: 'やま', Romaji: 'NoKanji' },
    { Id: '川', SinoVietnamese: 'XUYÊN', On: 'セン', Kun: 'かわ', Romaji: 'NoKanji' },

    { Id: '天', SinoVietnamese: 'THIÊN', On: 'テン', Kun: 'あまつ、あめ、あま', Romaji: 'NoKanji' },
    { Id: '気', SinoVietnamese: 'KHÍ', On: 'キ、ケ', Kun: 'き', Romaji: 'NoKanji' },
    { Id: '晴', SinoVietnamese: 'TÌNH', On: 'セイ', Kun: 'は、ば', Romaji: 'NoKanji' },
    { Id: '雨', SinoVietnamese: 'VŨ', On: 'ウ', Kun: 'あめ', Romaji: 'NoKanji' },
    { Id: '雪', SinoVietnamese: 'TUYẾT', On: 'セツ', Kun: 'ゆき', Romaji: 'NoKanji' },
    { Id: '雲', SinoVietnamese: 'VÂN', On: 'ウン', Kun: 'くも、ぐも', Romaji: 'NoKanji' },
    { Id: '風', SinoVietnamese: 'PHONG', On: 'フウ、フ', Kun: 'かぜ、かざ', Romaji: 'NoKanji' },
    { Id: '空', SinoVietnamese: 'KHÔNG', On: 'クウ', Kun: 'そら、あ、から、す、むな', Romaji: 'NoKanji' },
...
export const KanjiExample = [
    ...
    { Word: '夏休み', Hiragana: 'なつやすみ', Meaning: 'Kì nghỉ Hè' },
    ...
    { Word: '小川', Hiragana: 'おがわ', Meaning: 'Suối' },
...
export const Verb = [
    { Verb: 'NoVerb', Group: 'NoVerb', Meaning: 'NoVerb' },
